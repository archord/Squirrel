...
${OBJECTDIR}/src/CrossMatch.o: src/CrossMatch.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Ilibrary/astrometry.net-0.38/include -Ilibrary/cfitsio/include -Ilibrary/wcstools-3.8.5/include -I/usr/include/postgresql -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CrossMatch.o src/CrossMatch.cpp

${OBJECTDIR}/src/CrossMatchSphere.o: src/CrossMatchSphere.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Ilibrary/astrometry.net-0.38/include -Ilibrary/cfitsio/include -Ilibrary/wcstools-3.8.5/include -I/usr/include/postgresql -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CrossMatchSphere.o src/CrossMatchSphere.cpp

${OBJECTDIR}/src/Partition.o: src/Partition.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Ilibrary/astrometry.net-0.38/include -Ilibrary/cfitsio/include -Ilibrary/wcstools-3.8.5/include -I/usr/include/postgresql -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Partition.o src/Partition.cpp

${OBJECTDIR}/src/PartitionSphere.o: src/PartitionSphere.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Ilibrary/astrometry.net-0.38/include -Ilibrary/cfitsio/include -Ilibrary/wcstools-3.8.5/include -I/usr/include/postgresql -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/PartitionSphere.o src/PartitionSphere.cpp

${OBJECTDIR}/src/StarFile.o: src/StarFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Ilibrary/astrometry.net-0.38/include -Ilibrary/cfitsio/include -Ilibrary/wcstools-3.8.5/include -I/usr/include/postgresql -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/StarFile.o src/StarFile.cpp

${OBJECTDIR}/src/StarFileFits.o: src/StarFileFits.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Ilibrary/astrometry.net-0.38/include -Ilibrary/cfitsio/include -Ilibrary/wcstools-3.8.5/include -I/usr/include/postgresql -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/StarFileFits.o src/StarFileFits.cpp

${OBJECTDIR}/src/StoreDataPostgres.o: src/StoreDataPostgres.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -Ilibrary/astrometry.net-0.38/include -Ilibrary/cfitsio/include -Ilibrary/wcstools-3.8.5/include -I/usr/include/postgresql -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/StoreDataPostgres.o src/StoreDataPostgres.cpp
